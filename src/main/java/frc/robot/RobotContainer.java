...
//         switch (ModeConstants.currentMode) {
//             case REAL:
//                 tagVision = new VisionLocalizer(drive::addVisionMeasurement, VisionConstants.fieldLayout, new double[0], new VisionIOPhotonReal("front", new Transform3d()));
//                 break;
//             case SIM:
//                 tagVision = new VisionLocalizer(drive::addVisionMeasurement, VisionConstants.fieldLayout, new double[0], new VisionIOPhotonSim("front", new Transform3d(), drive::getPose, VisionConstants.fieldLayout));
//         //     case SIM:
//         //         if (FeatureFlags.runDrive) {
//         //             tagVision =
//         //                     new VisionLocalizer(
