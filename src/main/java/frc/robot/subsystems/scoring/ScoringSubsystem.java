...
import frc.robot.subsystems.scoring.ShooterIO.ShooterIOInputs;
...
public class ScoringSubsystem extends SubsystemBase {
    ...
    //private final IntakeIOInputs intakeInputs = new IntakeIOInputs();
    ...
    private void idle() {
        shooterIo.setAimAngleRad(-0.03);
        shooterIo.setShooterVelocity(0.0);
        shooterIo.setFromIntakeMotorVoltage(0);
        ...
        SmartDashboard.putNumber("Aimer Location", shooterInputs.aimAngleRad);
