...
public final class PhoenixDriveConstants {
    ...
    @JSONExclude
    public static final JSONSync<PhoenixDriveConstants> synced =
            new JSONSync<PhoenixDriveConstants>(
                    new PhoenixDriveConstants(),
                    "filePath",
    ...
    public final double maxSpeedMetPerSec = 6;
    public final double MaxAngularRateRadPerSec = Math.PI * 2;

    public final double autoAlignmentkP = 5.0;
    public final double autoAlignmentkI = 5.5;
    public final double autoAlignmentkD = 0.0;
    ...
    // sim constants
    public final double kSimLoopPeriod = 0.005;
