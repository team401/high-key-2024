...
public final class PhoenixDriveConstants {
    ...
    public static final SwerveModuleConstants FrontLeft =
            ConstantCreator.createModuleConstants(
                            ...
                            kFrontLeftEncoderId,
                            Rotations.of(kFrontLeftEncoderOffset),
                            Inches.of(kFrontLeftXPosInches),
                            Inches.of(kFrontLeftYPosInches),
                            kInvertLeftSide, false, false)
    ...
    public static final SwerveModuleConstants FrontRight =
            ConstantCreator.createModuleConstants(
                            ...
                            Rotations.of(kFrontRightEncoderOffset),
                            Inches.of(kFrontRightXPosInches),
                            Inches.of(kFrontRightYPosInches),
                            kInvertRightSide, false, false)
    ...
    public static final SwerveModuleConstants BackLeft =
            ConstantCreator.createModuleConstants(
                            ...
                            kBackLeftEncoderId,
                            Rotations.of(kBackLeftEncoderOffset),
                            Inches.of(kBackLeftXPosInches),
                            Inches.of(kBackLeftYPosInches),
                            kInvertLeftSide, false, false)
    ...
    public static final SwerveModuleConstants BackRight =
            ConstantCreator.createModuleConstants(
                            ...
                            kBackRightEncoderId,
                            Rotations.of(kBackRightEncoderOffset),
                            Inches.of(kBackRightXPosInches),
                            Inches.of(kBackRightYPosInches),
                            kInvertRightSide, false, false)
